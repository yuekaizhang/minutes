...
def get_speech_timestamps(audio,
                          ...
                          min_speech_duration_ms: int = 2500,
...
if __name__ == "__main__":
    model = OnnxWrapper("/mnt/samsung-t7/yuekai/hackthon/silero-vad/files/silero_vad.onnx")
    wav_path = "/mnt/samsung-t7/yuekai/hackthon/paraformerX/chat.wav"
    wav, sample_rate = soundfile.read(wav_path)
    t = get_speech_timestamps(wav, model)
    print(t)